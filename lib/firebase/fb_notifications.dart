...
//BACKGROUND Notifications - 10S & Android
  ...
  static Future<void> initNotifications() async {
    ...
    if (!kIsWeb) {
      channel = const AndroidNotificationChannel(
        'app_auth_notification_channel',
        'App Auth Notifications Channel',
    ...
    await localNotificationsPlugin.resolvePlatformSpecificImplementation<AndroidFlutterLocalNotificationsPlugin>()?.createNotificationChannel(channel);
